...
/**
 * This class is used to read data from a MySQL database using the standard
 * driver.
 *
 * @package Leap
 * @category MySQL
 ...
 * @abstract
 */
abstract class Base\DB\MySQL\DataReader\Standard extends DB\SQL\DataReader\Standard {
