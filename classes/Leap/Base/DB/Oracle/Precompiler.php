 ...
 * @abstract
 */
abstract class Base\DB\Oracle\Precompiler extends DB\SQL\Precompiler {
	...
	public function prepare_identifier($expr) {
		if ($expr instanceof DB\Oracle\Select\Builder) {
	...
	public static function is_keyword($token) {
		if (static::$xml === NULL) {
			static::$xml = Core\Data\Serialization\XML::load('config/sql/oracle.xml');
		}
