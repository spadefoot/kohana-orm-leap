...
/**
 * This class is used to read data from a MariaDB database using the improved
 * driver.
 *
 * @package Leap
 * @category MariaDB
 ...
 * @abstract
 */
abstract class Base_DB_MariaDB_DataReader_Improved extends DB_SQL_DataReader_Standard {
