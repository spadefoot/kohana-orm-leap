...
abstract class Base_DB_ORM_Relation_BelongsTo extends DB_ORM_Relation {
    ...
    public function __construct(DB_ORM_Model $active_record, Array $metadata = array()) {
        ...
        $this->metadata['parent_model'] = DB_ORM_Model::model_name($metadata['parent_model']); // the referenced table
        ...
        $this->metadata['child_model'] = get_class($active_record); // the referencing table
