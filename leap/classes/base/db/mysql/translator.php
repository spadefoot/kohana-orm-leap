 ...
 * @abstract
 */
abstract class Base_DB_MySQL_Translator implements Base_DB_SQL_Translator_Interface {

    /**
    * This variable stores the MySQL to Firebird SQL conversions mappings.
    *
    * @access protected
    * @static
    * @var array
    */
    ...
    /**
    * This variable stores the MySQL to MS SQL many-to-one conversions mapping.
    *
    * @access protected
    * @static
    * @var array
    */
    ...
    /**
    * This variable stores the original MySQL statement.
    *
    * @access public
    * @var string
    */
    ...
    *
    * @access public
    * @param string $sql                            the MySQL statement to be translated
    */
    ...
    /**
    * This function translates the MySQL statement to a Firebird SQL statement.
    *
    * @access public
    ...
    */
    ...
    /**
    * This function translates the MySQL statement to a MS SQL statement.
    *
    * @access public
    ...
    */
    ...
    /**
    * This function returns a cleaned-up version of the MySQL statement.
    *
    * @access public
    * @return string                                the cleaned-up MySQL statement
    */
